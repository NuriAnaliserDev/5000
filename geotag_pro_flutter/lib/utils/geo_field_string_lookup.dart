...
String? lookupGeoFieldString(GeoFieldStrings s, String key) {
  switch (key) {
    ...
    case 'fab_reset_desc': return s.fab_reset_desc;
    case 'fab_reset_done': return s.fab_reset_done;
    case 'fab_reset_map': return s.fab_reset_map;
    case 'fab_reset_prompt': return s.fab_reset_prompt;
    case 'fab_reset_title': return s.fab_reset_title;
