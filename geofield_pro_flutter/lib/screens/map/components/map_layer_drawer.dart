                ...
                children: [
                  Row(
                    children: [
                      ...
                      Text(context.loc('layer_management'),
                  ...
                  _buildSlider(context, context.loc('layer_base_map'),
                      baseLayerOpacity, onBaseOpacityChanged),
                  _buildSlider(context, context.loc('layer_gis_kml'),
                      gisLayerOpacity, onGisOpacityChanged),
                  _buildSlider(context, context.loc('layer_drawings'),
                      drawingLayerOpacity, onDrawingOpacityChanged),
                  ...
                  TextButton.icon(
                    ...
                    icon: const Icon(Icons.file_download_outlined,
                        size: 14, color: Color(0xFF90CAF9)),
                    label: Text(
                  ...
                  Text(
                    ...
                    style: const TextStyle(
                        color: Colors.white38, fontSize: 8, height: 1.25),
                  ),
                  const Divider(color: Colors.white10),
                  TextButton.icon(
                    onPressed: onToggleVertexEdit,
                    icon: Icon(isVertexEditMode ? Icons.edit_off : Icons.edit,
                        size: 14, color: Colors.orange),
                    label: Text(
                      isVertexEditMode
                          ? context.loc('edit_disable')
                          : context.loc('edit_enable'),
                      style: const TextStyle(
                          fontSize: 10,
                          color: Colors.orange,
                          fontWeight: FontWeight.bold),
