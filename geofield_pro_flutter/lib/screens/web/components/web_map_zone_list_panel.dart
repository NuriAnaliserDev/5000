                ...
                : ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        selected: isSelected,
                        selectedTileColor:
                            b.displayColor.withValues(alpha: 0.08),
                        leading: Container(
                          width: 36,
                          height: 36,
                          decoration: BoxDecoration(
                          ...
                          child: Icon(_zoneIcon(b.zoneType),
                              color: b.displayColor, size: 18),
                        ),
                        title: Text(
                          b.name,
                          style: const TextStyle(
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                if (b.points.isNotEmpty) {
                                  final centerLat = b.points
                                          .map((p) => p.latitude)
                                          .reduce((a, c) => a + c) /
                                      b.points.length;
                                  final centerLng = b.points
                                          .map((p) => p.longitude)
                                          .reduce((a, c) => a + c) /
                                      b.points.length;
                                  mapController.move(
                                      LatLng(centerLat, centerLng), 15);
                                  onSelect(b);
                                }
                              },
                            ),
