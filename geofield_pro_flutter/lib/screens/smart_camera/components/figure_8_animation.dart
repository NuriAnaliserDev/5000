  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, _) => CustomPaint(
          size: const Size(100, 60), painter: _Figure8Painter(_ctrl.value)),
    );
  }
}
...
class _Figure8Painter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.cubicTo(size.width * 0.8, size.height * 0.1, size.width * 1.1,
        size.height * 0.9, size.width / 2, size.height / 2);
    path.cubicTo(size.width * 0.2, size.height * 0.1, -size.width * 0.1,
        size.height * 0.9, size.width / 2, size.height / 2);
